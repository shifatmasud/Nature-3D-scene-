...
const lightThemeColors = {
  Color: {
    ...
    Accent: {
      Surface: { '1': '#0052FF', '2': '#D6E4FF' },
      Content: { '1': '#FFFFFF', '2': '#002E8E' }
    },
...
const darkThemeColors = {
  Color: {
    ...
    Accent: {
      Surface: { '1': '#448AFF', '2': '#2A3C5B' },
      Content: { '1': '#121212', '2': '#AECBFF' }
    },
...
const typography = {
  Type: {
    ...
    Readable: {
      ...
      Label: {
        L: { fontSize: '14px', lineHeight: '20px', fontWeight: 500, letterSpacing: '0.02em', tag: 'span', fontFamily: "'Inter', sans-serif" },
